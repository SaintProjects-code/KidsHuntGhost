...
var ROUTES := [
	...
	{ "from": "B", "to": "J3", "corners": [], "spaces": 3,
		"types": [&"PKMN_PINK", &"EVENT", &"PKMN_PINK"] },
	{ "from": "C", "to": "H", "corners": [], "spaces": 5,
		"types": [&"PKMN_GREEN", &"ITEM", &"PKMN_GREEN", &"EVENT", &"PKMN_GREEN"] },
	{ "from": "C", "to": "J5", "corners": [], "spaces": 1,
		"types": [&"EVENT"] },
	{ "from": "E", "to": "D", "corners": [Vector2i(46, 66),Vector2i(46, 35)], "spaces": 5,
		"types": [&"PKMN_GREEN", &"EVENT", &"ITEM", &"PKMN_GREEN", &"EVENT"] },
	{ "from": "H", "to": "J8", "corners": [], "spaces": 2,
		"types": [&"PKMN_GREEN", &"ITEM"] },
	{ "from": "D", "to": "J6", "corners": [], "spaces": 5,
		"types": [&"PKMN_GREEN", &"EVENT", &"PKMN_GREEN", &"ITEM", &"PKMN_GREEN"] },
	{ "from": "D", "to": "F", "corners": [Vector2i(91, 36),Vector2i(91, 25),Vector2i(104, 25)], "spaces": 5,
		"types": [&"PKMN_RED", &"ITEM", &"COMPETITION", &"PKMN_RED", &"PKMN_RED"] },
	...
	{ "from": "J1", "to": "J2", "corners": [Vector2i(7, 43),Vector2i(7, 21)], "spaces": 4, "name_of": "J1",
		"types": [&"EVENT",&"PKMN_PINK", &"ITEM", &"PKMN_PINK"] },
	{ "from": "J1", "to": "J2", "corners": [], "spaces": 4, "name_of": "J2",
		"types": [&"EVENT", &"PKMN_PINK", &"PKMN_PINK", &"COMPETITION"] },
	{ "from": "J2", "to": "B", "corners": [], "spaces": 4,
		"types": [&"PKMN_PINK", &"ITEM", &"EVENT", &"PKMN_PINK"] },

	{ "from": "J3", "to": "J4", "corners": [Vector2i(28, -21),Vector2i(61, -22)], "spaces": 4, "name_of": "J3",
		"types": [&"PKMN_PINK", &"EVENT", &"ITEM", &"PKMN_PINK"] },
	{ "from": "J3", "to": "J4", "corners": [], "spaces": 4, "name_of": "J4",
		"types": [&"ITEM", &"PKMN_PINK", &"EVENT", &"PKMN_PINK"] },
	{ "from": "J4", "to": "C", "corners": [], "spaces": 4,
		"types": [&"PKMN_PINK", &"EVENT", &"PKMN_PINK", &"PKMN_PINK"] },

	{ "from": "J5", "to": "E", "corners": [Vector2i(42, -1),Vector2i(42, 10),Vector2i(30, 10)], "spaces": 10,
		"types": [&"EVENT",&"PKMN_GREEN" , &"ITEM", &"PKMN_GREEN", &"PKMN_GREEN", &"EVENT", &"PKMN_GREEN", &"PKMN_GREEN", &"EVENT", &"PKMN_GREEN"] },
	{ "from": "J5", "to": "D", "corners": [Vector2i(85, 12),Vector2i(65, 13)], "spaces": 6,
		"types": [&"PKMN_GREEN", &"ITEM", &"EVENT", &"PKMN_GREEN",&"PKMN_GREEN",&"EVENT"] },

	{ "from": "J6", "to": "J7", "corners": [Vector2i(116, 70)], "spaces": 4, "name_of": "J6",
		"types": [&"PKMN_GREEN", &"EVENT", &"ITEM", &"PKMN_RED"] },
	{ "from": "J6", "to": "J7", "corners": [Vector2i(66, 86)], "spaces": 4, "name_of": "J7",
		"types": [&"ITEM", &"PKMN_GREEN", &"EVENT", &"PKMN_RED"] },
	{ "from": "J7", "to": "G", "corners": [], "spaces": 4,
		"types": [&"PKMN_RED", &"EVENT", &"ITEM", &"PKMN_RED"] },

	{ "from": "J8", "to": "J9", "corners": [], "spaces": 6, "name_of": "J8",
		"types": [&"PKMN_GREEN", &"COMPETITION", &"ITEM", &"PKMN_GREEN", &"PKMN_RED", &"EVENT"] },
	{ "from": "J8", "to": "J9", "corners": [Vector2i(132, 7),Vector2i(132, 54)], "spaces": 5, "name_of": "J9",
		"types": [&"PKMN_GREEN", &"ITEM", &"EVENT", &"PKMN_RED", &"PKMN_RED"] },
	{ "from": "J9", "to": "G", "corners": [], "spaces": 4,
		"types": [&"PKMN_RED", &"EVENT", &"ITEM", &"PKMN_RED"] },
...
func _draw() -> void:
	...
	for node_name in NODES:
		...
		draw_circle(cc, CITY_RADIUS, Color(CITY_COLOR, MARKER_ALPHA))
		_draw_label(cc, "City")
